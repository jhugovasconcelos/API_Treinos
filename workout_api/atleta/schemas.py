...
class AtletaUpdate(BaseSchema):
    ...
    peso: Annotated[Optional[PositiveFloat], Field(None, description='Peso do atleta', example=74.2)]
    altura: Annotated[Optional[PositiveFloat], Field(None, description='Altura do atleta', example=1.84)]
